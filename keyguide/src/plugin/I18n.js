.pragma library
.import "AppTranslations.js" as AppTranslations
...
// missing.
const localeOrder = ["en", "ko", "ja", "zh_CN", "es", "de", "fr", "uk", "hu"]
const languageNames = {
  en: "English",
  ko: "한국어",
  ja: "日本語",
  zh_CN: "简体中文",
  es: "Español", de: "Deutsch", fr: "Français", uk: "Українська", hu: "Magyar"
}
...
function text(language, key, parameters) {
  ...
  const source = message ? (message[languageIndex(language)] || AppTranslations.text(language, message[0])) : String(key || "")
...
function sourceText(language, source) { return AppTranslations.text(language, source) }
