...
// Shared by the live HUD and settings preview.
function categoryIcon(kind) {
  return {desktopApp: "󰀻", webapp: "󰖟", cmd: "󰆍", systemUi: "󰒓", action: "󱐋"}[kind] || ""
}
function categoryLegendKinds(showActions) {
  return ["desktopApp", "webapp", "cmd", "systemUi"].concat(showActions === false ? [] : ["action"])
}
